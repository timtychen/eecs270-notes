...
Literals include every variable exactly once

Ex: F = a'bc' + a'bc + abc

Minterms (Products of Sums)
...
Equations to Circuits- Straightforward

Circuits to Equations- Start from inputs, work towards final output

Equations to Truth Tables- List all combinations of inputs, then list results of functions in
intermediate columns

Truth Tables to Equations- For each 1 in output column, create a product term of inputs, then 
add them all up to get output
